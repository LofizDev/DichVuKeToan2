...
const seed = async () => {
  try {
    ...
    const settings = new Setting({
      ...
      siteNameZh: '专业会计服务',
      companyName: 'CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG',
      companyNameZh: '越兴服务与咨询有限公司',
      email: 'zintaxfinance.info@gmail.com',
      ...
      logoUrl: '/assets/images/ketoanchuyennghiep-banner.webp'
    });
    await settings.save();
    ...
    const sliders = [
      {
        imageUrl: '/assets/images/slider3.webp',
      ...
      {
        imageUrl: '/assets/images/slider1_THUEYEN.png',
    ...
    const sections = [
      {
        ...
        titleZh: '全套会计服务',
        content: `<p><span style="color: #ed1c24;"><strong>Dịch vụ kế toán thuế trọn Gói giá rẻ</strong>&nbsp;–&nbsp;</span><strong><span style="color: #ed1c24;">dịch vụ báo cáo thuế tháng, quý</span>&nbsp;</strong> trọn gói của <span class="company-name-placeholder"><strong>CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG</strong></span> với mức chi phí chỉ từ <strong>500.000 – 5&nbsp;triệu/tháng</strong>&nbsp;cam kết chất lượng uy tín và bảo mật thông tin Tại sao quý doanh nghiệp nên lựa chọn dịch vụ kế toán trọn gói và những khó khăn của doanh nghiệp:</p>
...
<p><span style="color: #ed1c24;"><strong>Khách hàng cần cung cấp gì khi sử dụng dịch vụ kế toán trọn gói của&nbsp;<span class="company-name-placeholder">CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG</span></strong></span></p>
<p>– Cung cấp hóa đơn đầu vào, đầu ra ( Hóa đơn gốc hoặc photo )</p>
<p>– Thiết bị chữ ký số để nộp báo báo thuế qua mạng.</p>`,
        contentZh: `<p><span style="color: #ed1c24;"><strong>廉价全套税务会计服务</strong>&nbsp;–&nbsp;</span><strong><span style="color: #ed1c24;">由<span class="company-name-placeholder">越兴服务与咨询有限公司</span>提供的全套月度、季度税务申报服务</span>&nbsp;</strong>，费用仅从<strong>500.000 – 5.000.000 越南盾/月起</strong>&nbsp;，承诺质量信誉与信息保密。为什么企业应该选择全套会计服务以及企业面临的困难：</p>
...
<p><span style="color: #ed1c24;"><strong>客户在使用<span class="company-name-placeholder">越兴服务与咨询有限公司</span>的全套会计服务时需要提供什么：</strong></span></p>
...
<p>– 数字证书设备（Token），以便通过网络提交税务申报。</p>`,
      ...
      },
      {
        ...
        titleZh: '专业会计服务',
        content: `<p>Dịch vụ Thành Lập Công Ty trọn gói uy tín giá rẻ tại Hà Nội, Hải Phòng, Bắc Ninh, Hải Dương&nbsp;<span class="company-name-placeholder"><strong>CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG</strong></span>&nbsp;Là một trong những công ty hàng đầu về mảng dịch vụ thành lập công ty&nbsp;và&nbsp; dịch vụ kế toán&nbsp;, bởi đội ngũ luật sư chuyên nghiệp và đội ngũ kế toán trưởng nhiều năm kinh nghiệm trực tiếp đảm nhận do vậy khi lựa chọn gói dịch vụ thành lập doanh nghiệp của chúng tôi quý doanh nghiệp có thể yên tâm về dịch vụ nhanh gọn- hồ sơ giải quyết nhanh nhất không những thế chúng tôi sẽ tư vấn về mảng kế toán cho doanh nghiệp khi bắt đầu hoạt động, nếu quý doanh nghiệp lựa chọn gói dịch vụ thành lập công ty thì&nbsp;<span class="company-name-placeholder"><strong>CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG</strong></span>&nbsp;sẽ miễn phí hỗ trợ tư vấn các thủ tục ban đầu về thuế và kế toán cho quý doanh nghiệp<br></p>`,
        contentZh: `<p>在河内、海防、北宁、海阳提供信誉良好、价格实惠的全套公司注册服务&nbsp;<span class="company-name-placeholder"><strong>越兴服务与咨询有限公司</strong></span>&nbsp;是公司注册及会计服务领域的领先公司之一，由专业律师团队和多年经验的会计师长直接负责。因此，当选择我们的企业成立服务包时，贵企业可以放心，服务快捷，档案解决最快。不仅如此，在企业开始运营时，我们还会为企业提供会计方面的咨询。如果贵企业选择公司注册服务包，&nbsp;<span class="company-name-placeholder"><strong>越兴服务与咨询有限公司</strong></span>&nbsp;将免费协助咨询企业初期的税务与会计手续。</p>`,
        order: 2
      },
      {
...
<p><span style="color: #ed1c24;"><strong>Cam kết của <span class="company-name-placeholder">CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG</span> sau dịch vụ thành lập công ty – Thành lập doanh nghiệp:</strong></span></p>
...
<p>&nbsp;CHỈ TỪ 1.000.000đ ĐẾN 3.000.000đ</p>`,
        contentZh: `<p>在河内、海防、北宁、海阳提供信誉良好、价格实惠的全套公司注册服务&nbsp;<span class="company-name-placeholder"><strong>越兴服务与咨询有限公司</strong></span>&nbsp;是公司注册及会计服务领域的领先公司之一，由专业律师团队和多年经验的会计师长直接负责。因此，当选择我们的企业成立服务包时，贵企业可以放心，服务快捷，档案解决最快。不仅如此，在企业开始运营时，我们还会为企业提供会计方面的咨询。如果贵企业选择公司注册服务包，&nbsp;<span class="company-name-placeholder"><strong>越兴服务与咨询有限公司</strong></span>&nbsp;将免费协助咨询企业初期的税务和会计手续。</p>
<p><span style="color: #ed1c24;"><strong><span class="company-name-placeholder">越兴服务与咨询有限公司</span></strong></span>&nbsp;不仅在河内承接公司注册服务，还在海防、北宁、海阳等省份承接。凭借在私营企业成立咨询方面的多年经验和优秀员工团队，我们将在客户登记使用我们的服务时，帮助客户节省成本、时间和享受最佳服务质量。</p>
...
<p><span style="color: #ed1c24;"><strong><span class="company-name-placeholder">越兴服务与咨询有限公司</span>在公司注册/企业成立服务后的承诺：</strong></span></p>
...
<p>Tại sao doanh nghiệp lựa chọn dịch vụ dọn dẹp sổ sách kế toán: – Hệ thống sổ sách, chứng từ chứa nhiều sai xót. Nguyên nhân là do không kịp thời cập nhật các thông tư, chính xác của cơ quan thuế và bộ tài chính. – Hệ thống chứng từ thiếu xót, bị mất mát, lộn xộn và không hợp mà chủ doanh nghiệp và kế toán của doanh nghiệp không hề biết. – Sự không chính xác hay không khớp nhau trong những sổ sách kế toán. Số liệu được làm ko chi tiết cụ thể và chứa nhiều điều bất hợp lý. – Việc dọn dẹp hoàn thiện sổ sách kế toán chưa được quan tâm đúng mức – Những vấn đề trong thực trạng trên sẽ dẫn đến doanh nghiệp có nguy cơ bị cơ quan thuế xử phạt rất nặng khi đến kỳ quyết toán thuế nếu như chưa kịp thời hoàn thiện sổ sách kế toán. – Từ thực trạng trên,&nbsp;<span style="color: #ed1c24;"><strong><span class="company-name-placeholder">CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG</span></strong></span>&nbsp;giới thiệu quý doanh nghiệp&nbsp;<span style="color: #ed1c24;"><strong>Gói dịch vụ dọn dẹp sổ sách kế toán</strong></span>&nbsp;để giúp quý doanh nghiệp tạo dựng hệ thống sổ sách kế toán chuyên nghiệp và chính xác và sẵn sàng quyết toán thuế bất cứ lúc nào.</p>
...
<p>为什么企业选择账簿清理服务： – 账簿和凭证系统存在许多错误。原因是没有及时更新财政部和总税务局的通知与政策。 – 凭证系统不全、丢失、混乱且不合规，而企业主和企业的会计却完全不知情。 – 会计账簿中数据不准确或不一致。数据编制不具体、不详细，存在很多不合理之处。 – 会计账簿的整理和完善工作未得到应有的重视。 – 上述实际情况中的问题，将导致企业在面临税务稽查时，如果未能及时完善会计账簿，可能会被税务机关处以重罚。 – 针对上述实际情况，&nbsp;<span style="color: #ed1c24;"><strong><span class="company-name-placeholder">越兴服务与咨询有限公司</span></strong></span>&nbsp;特向贵企业介绍&nbsp;<span style="color: #ed1c24;"><strong>全套账簿清理服务包</strong></span>&nbsp;，以帮助贵企业建立专业、准确的会计账簿系统，随时准备应对税务稽查。</p>
...
<p>Hãy liên hệ ngay&nbsp;<span style="color: #ed1c24;"><strong><span class="company-name-placeholder">CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG</span></strong></span>&nbsp;lựa chọn an tâm nhất bởi đội ngũ kế toán trưởng trên 10 năm kinh nghiệm và đã có chứng chỉ hành nghề do tổng cục thuế ban hành đã và đang làm kế toán, kiểm toán báo cáo tài chính cho rất nhiều doanh nghiệp, từng làm dịch vụ báo cáo tài chính và đã quyết toán cho hơn 1000 doanh nghiệp tại Hà Nội chính thế chúng tôi có thể xử lý tất cả các loại hình doanh nghiệp thương mai, dịch vụ, sản xuất, xây lắp, nhà hàng khách sạn, vận tải, tất cả các các loại hình công ty khác kể cả các công ty vốn đầu tư nước ngoài. Không chỉ đảm nhận dịch vụ báo cáo tài chính cho các doanh nghiệp <span class="company-name-placeholder">CÔNG TY TNHH DỊCH VỤ VÀ TƯ VẤN VIỆT HƯNG</span> còn chuyên làm các gói dịch vụ kế toán trọn gói, dọn dẹp rà soát sổ sách, quyết toán thuế, hoàn thuế GTGT – XNK, kể cả dịch vụ kiểm toán báo cáo tài chính cho doanh nghiệp.</p>
...
<p>请立即联系&nbsp;<span style="color: #ed1c24;"><strong><span class="company-name-placeholder">越兴服务与咨询有限公司</span></strong></span>&nbsp;，这是您最安心的选择。我们的首席会计师团队拥有10年以上的经验，并持有总税务局颁发的执业资格证书。我们已经并在为许多企业提供会计和财务报表审计工作，曾为河内的1000多家企业提供财务报表服务并完成税务审计。因此，我们能够处理所有类型的企业：贸易、服务、生产、建筑安装、餐饮酒店、运输，以及所有其他类型的公司，包括外资企业。不仅承接企业的财务报表服务，&nbsp;<span class="company-name-placeholder">越兴服务与咨询有限公司</span>&nbsp;还专业提供全套会计服务、账簿整理核对、税务结算、增值税（GTGT）与进出口（XNK）退税，甚至企业的财务报表审计服务。</p>
