...
export const CompanySetup: React.FC<CompanySetupProps> = ({ section, settings }) => {
  ...
  return (
    <section id="thanh-lap-cong-ty" className="py-12 bg-white px-4 border-b border-gray-100">
